...
footerItem1.append(document.createTextNode('Todo-List'));
...
const facebook = make('a','footer-link my-3', undefined,{href:'#'});
facebook.appendChild(document.createTextNode('Facebook'));
const twitter = make('a', 'footer-link my-3', undefined, { href: '#' });
twitter.appendChild(document.createTextNode('Twitter'));
const github = make('a', 'footer-link my-3', undefined, { href: '#' });
github.appendChild(document.createTextNode('Github'));
const linkedin = make('a', 'footer-link my-3', undefined, { href: '#' });
